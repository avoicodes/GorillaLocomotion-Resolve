...
//Gorilla Locomotion Resolve by Oblixo
//Go to https://github.com/avoicodes/GorillaLocomotion-Resolve/ for updates
...
struct Player : BNM::UnityEngine::MonoBehaviour
{
    ...
    {
        static Field<Player*> instance = GetClass().GetField("_instance");
        return instance();
    }

    static Player* GetInstance()
    {
        static Method<Player*> Instance = GetClass().GetMethod("get_Instance");
        return Instance();
    }
    ...
    {
        static Method<bool> IterativeCollisionSphereCast = GetClass().GetMethod("IterativeCollisionSphereCast", 8);
    ...
    {
        static Method<bool> CollisionsSphereCast = GetClass().GetMethod("CollisionsSphereCast", 8);
